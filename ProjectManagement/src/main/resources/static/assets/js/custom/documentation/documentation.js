    ...
    return {
        init: function(i) {
            ...
            e = document.querySelector("#kt_docs_aside_menu_wrapper"),
                ...
                function(e) {
                    var t = e;
                    if (void 0 === t && (t = document.querySelectorAll(".highlight")),
                    t && t.length > 0)
                            ...
                            if (o)
                                new ClipboardJS(o,{
                                    target: function(e) {
                                        ...
                                        return null == n && (n = t.querySelector(".highlight-code")),
                                            n
                                    }
            ...
            e && (c = e.querySelector(".menu-link.active")) && !0 !== KTUtil.isVisibleInContainer(c, e) && e.scroll({
