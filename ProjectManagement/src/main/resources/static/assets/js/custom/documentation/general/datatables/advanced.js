            ...
            $("#kt_datatable_column_rendering").DataTable({
                columnDefs: [{
                    render: function(e, a, n) {
                        ...
                        return e + '<span class="ms-2 badge badge-light-' + t[r].state + ' fw-bold">' + t[r].title + "</span>"
                    },
                    targets: 1
                }]
            }),
                ...
                drawCallback: function(t) {
                    ...
                    e.column(2, {
                        page: "current"
                            ...
                            n !== t && ($(a).eq(e).before('<tr class="group fs-5 fw-bolder"><td colspan="5">' + t + "</td></tr>"),
                                n = t)
                        }
                    ))
                }
            ...
            $("#kt_datatable_footer_callback").DataTable({
                footerCallback: function(t, e, a, n, r) {
                    var s = this.api()
                        ...
                        , i = s.column(4).data().reduce((function(t, e) {
                            return l(t) + l(e)
                        }
                    ), 0)
                        , o = s.column(4, {
                    ...
                    $(s.column(4).footer()).html("$" + o + " ( $" + i + " total)")
                }
            }),
