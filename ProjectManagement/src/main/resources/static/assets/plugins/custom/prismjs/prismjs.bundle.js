var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}
	...
	var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i
		...
		highlight: function(e, t, a) {
			...
			if (s.hooks.run("before-tokenize", n),
				!n.grammar)
		...
		for (var p in a)
			if (a.hasOwnProperty(p) && a[p]) {
				...
				for (var m = 0; m < g.length; ++m) {
					...
					for (var w = f.pattern || f, F = n.next, P = l; F !== t.tail && !(d && P >= d.reach); P += F.value.length,
						F = F.next) {
						var A = F.value;
						...
						if (!(A instanceof r)) {
							var S, x = 1;
							if (y) {
								if (!(S = i(w, P, e, b)) || S.index >= e.length)
									break;
								var _ = S.index
									, $ = S.index + S[0].length
									, E = P;
	...
	function c(e, t, a) {
		for (var n = t.next, s = 0; s < a && n !== e.tail; s++)
			n = n.next;
		t.next = n,
			n.prev = t,
			e.length -= s
...
Prism.languages.markup && (Prism.languages.markup.tag.addInlined("script", "javascript"),
	...
	function() {
		if (void 0 !== Prism && "undefined" != typeof document) {
			...
			Prism.fileHighlight = function() {
				r || (console.warn("Prism.fileHighlight is deprecated. Use `Prism.plugins.fileHighlight.highlight` instead."),
					r = !0),
	...
	function(e) {
		...
		for (var s = ["comment", "function-name", "for-or-select", "assign-left", "parameter", "string", "environment", "function", "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number"], r = n.variable[1].inside, i = 0; i < s.length; i++)
						...
						if ((!e.settings || !1 !== e.settings["whitespace-normalization"]) && Prism.util.isActive(e.element, "whitespace-normalization", !0))
							if (e.element && e.element.parentNode || !e.code) {
								...
								if (e.code && n && "pre" === n.nodeName.toLowerCase()) {
									for (var s in null == e.settings && (e.settings = {}),
										t)
									...
									for (var o = n.childNodes, l = "", u = "", c = !1, d = 0; d < o.length; ++d) {
										var p = o[d];
										p == e.element ? c = !0 : "#text" === p.nodeName && (c ? u += p.nodeValue : l += p.nodeValue,
											n.removeChild(p),
											--d)
									}
